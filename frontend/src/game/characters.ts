...
import adamRunUrl from "../assets/Modern tiles_Free/Characters_free/Adam_run_16x16.png";
import adamIdleUrl from "../assets/Modern tiles_Free/Characters_free/Adam_idle_anim_16x16.png";
import alexRunUrl from "../assets/Modern tiles_Free/Characters_free/Alex_run_16x16.png";
import alexIdleUrl from "../assets/Modern tiles_Free/Characters_free/Alex_idle_anim_16x16.png";
import ameliaRunUrl from "../assets/Modern tiles_Free/Characters_free/Amelia_run_16x16.png";
import ameliaIdleUrl from "../assets/Modern tiles_Free/Characters_free/Amelia_idle_anim_16x16.png";
import bobRunUrl from "../assets/Modern tiles_Free/Characters_free/Bob_run_16x16.png";
import bobIdleUrl from "../assets/Modern tiles_Free/Characters_free/Bob_idle_anim_16x16.png";
...
export class AgentCharacter extends ex.Actor {
  private targetX = 0;
  private targetY = 0;
  private idleTimer = 0;
  ...
  constructor(
    ...
    // Build animations for all 4 directions
    ...
    this.label = new ex.Label({
      text: `${owner}`,
      pos: ex.vec(0, -FRAME_H * SCALE / 2 - 22),
      anchor: ex.vec(0.5, 0.5),
      font: new ex.Font({
        family: "monospace",
        size: 12,
    ...
    // Task label
    this.taskLabel = new ex.Label({
      text: task,
      pos: ex.vec(0, -FRAME_H * SCALE / 2 - 8),
      anchor: ex.vec(0.5, 0.5),
      font: new ex.Font({
        family: "monospace",
        size: 10,
        color: ex.Color.fromHex("#aaaaff"),
        textAlign: ex.TextAlign.Center,
        shadow: { offset: ex.vec(1, 1), color: ex.Color.Black, blur: 2 },
      }),
      z: 10,
